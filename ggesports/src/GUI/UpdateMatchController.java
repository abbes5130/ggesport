...
public class UpdateMatchController implements Initializable {
    ...
    private void UpdateMatch(ActionEvent e) {
        ...
        Match match = new Match(matchId,selectedAwayTeam.id, selectedHomeTeam.id, Time.valueOf(time.getText()), gettedDatePickerDate, location.getText(), seatsNumber, gamePrice, link.getText());
