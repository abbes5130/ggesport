...
public class Reservation {
    ...
    public String toString() {
        return "Reservation{" + "id_ticket=" + id_ticket + ", id_match=" + id_match + ", id_user=" + id_user + ", firstname=" + firstname + ", lastname=" + lastname + ", date=" + date + ", time=" + time + ", location=" + location + ", price=" + price + '}';
    }
