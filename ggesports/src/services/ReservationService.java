...
public class ReservationService implements IService<Reservation> {
    ...
    public void CreateRes(int user_id, int match_id) {
        String req = "INSERT INTO reservation ( id_match, id_user) SELECT matches.id_match, users.id_user FROM users, matches WHERE users.id_user = ? AND matches.id_match = ?;";
    ...
    public List<Reservation> RetrieveRes(int idUser) {
        ...
        try {
            ...
            String req = "SELECT * FROM (reservation, users, matches) WHERE (reservation.id_user=?) AND (reservation.id_user = users.id_user) AND (reservation.id_match = matches.id_match)";
            statement = (PreparedStatement) cnx2.prepareStatement(req);
            ...
            while (rst.next()) {
                ...
                t.setId_ticket(rst.getInt("id_ticket"));
                t.setId_match(rst.getInt("id_match"));
                t.setId_user(rst.getInt("id_user"));
