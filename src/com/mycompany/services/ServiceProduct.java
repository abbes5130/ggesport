...
public class ServiceProduct {
    ...
    public ArrayList<Category> getAllCategories() {
        String url = Statics.BASE_URL+"/api" + "/product/getListCategories";
        req.setUrl(url);
        req.setPost(false);
    ...
    public ArrayList<Product> parseProducts(String jsonText){
     ...
     public ArrayList<Product> getAllProducts(){
        ...
        String url = Statics.BASE_URL+"/api"+"/productsList";
        r.setUrl(url);
        r.setPost(false);
     ...
     String url =Statics.BASE_URL+"/api"+ "/DetailProduct" +id;
     req.setUrl(url);
     req.setPost(false);
     req.addResponseListener(new ActionListener<NetworkEvent>(){
             @Override
     ...
     public boolean deleteProduct(int id){
         String urlDelete =Statics.BASE_URL+"/api"+ "/DeleteProduct?idProduct="+id;
        ...
        public boolean updateProduct(int id, Product p){
            ...
            String url = Statics.BASE_URL+"/api" + "/UpdateProduct?id=" + id + 
                "&name=" + p.getName() 
                + "&price=" + p.getPrice()
                + "&description=" + p.getDescription()
                + "&color=" + p.getColor()
